...
<body>
<h1>Register here!</h1>
<p>Fill in your name, email address and tovar then click <strong>Submit</strong>
to register.</p>
...
$sql_insert ="INSERT INTO registration_on (name, email, date, tovar) VALUES (?,?,?,?)";
$stmt = $conn->prepare($sql_insert);
$stmt->bindValue(1, $name);
$stmt->bindValue(2, $email);
$stmt->bindValue(3, $date);
$stmt->bindValue(4, $tovar);
$stmt->execute();
