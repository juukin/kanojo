<html>
	...
	Сыр<input type="text" 
	name="tireqty"  value "tireqty" = 100 size= "3" maxlength="3" id="tireqty"/></br>
	Масло<input type="text" 
	name="oilqty"  value "oilqty" = 50 size= "3" maxlength="3" id="oilqty"/></br>
	Майонез<input type="text" 
	name="sparkqty" value "sparkqty" = 40 size= "3" maxlength="3" id="sparkqty"/></br>
